...
#JN_PACKAGE9=$ROS_HOME_WS/VehiculoVigilanciaAutonomo/VVA_ws/src/vva_navigation
#JN_PACKAGE10=$ROS_HOME_WS/VehiculoVigilanciaAutonomo/VVA_ws/src/vva_nav_test                # No requerido en este release
...
#JN_PACKAGE14=$ROS_HOME_WS/VehiculoVigilanciaAutonomo/VVA_ws/src/vva_voice_interact_client   # No requerido en este release
#JN_PACKAGE15=$ROS_HOME_WS/VehiculoVigilanciaAutonomo/VVA_ws/src/vva_voice_interact_server   # No requerido en este release
...
#~ scp -r \
  ...
  #~ ubuntu@$JNano_IP:/home/ubuntu/ROS/VehiculoVigilanciaAutonomo/EmailNotificationAndWatchdogScripts/
...
#--------------------------------------------
#scp -r \
#  $ROS_HOME_WS/VehiculoVigilanciaAutonomo/ROSCompiledPackages_ws/src/depth_nav_tools \
#  $ROS_HOME_WS/VehiculoVigilanciaAutonomo/ROSCompiledPackages_ws/src/robot_pose_publisher \
#  $ROS_HOME_WS/VehiculoVigilanciaAutonomo/ROSCompiledPackages_ws/src/web_video_server \    # Not required on ROS Melodic
#  ubuntu@$JNano_IP:/home/ubuntu/ROS/ROSCompiledPackages/ROSCompiledPackages_ws/src/


# Upload the OpenVPN configuration:
#--------------------------------------------
#scp -r \
#  $ROS_HOME_WS/VehiculoVigilanciaAutonomo/ConfiguracionOpenVPN/20210721_ClientJNano \
#  ubuntu@$JNano_IP:/home/ubuntu/
