package com.vva.vvamobileclient;
...
import com.vva.vvamobileclient.Core.ControlMode;
import com.vva.vvamobileclient.Core.DrawerItem;
import com.vva.vvamobileclient.Core.IWaypointProvider;
import com.vva.vvamobileclient.Core.NavDrawerAdapter;
import com.vva.vvamobileclient.Core.Plans.RobotPlan;
import com.vva.vvamobileclient.Core.RobotController;
import com.vva.vvamobileclient.Core.RobotInfo;
import com.vva.vvamobileclient.Core.RobotStorage;
import com.vva.vvamobileclient.Core.Savable;
import com.vva.vvamobileclient.Core.Utils;
import com.vva.vvamobileclient.Core.VVAVoiceAudioRecord;
import com.vva.vvamobileclient.Core.WarningSystem;
import com.vva.vvamobileclient.Fragments.AboutFragment;
import com.vva.vvamobileclient.Fragments.CameraViewFragment;
import com.vva.vvamobileclient.Fragments.HUDFragment;
import com.vva.vvamobileclient.Fragments.JoystickFragment;
import com.vva.vvamobileclient.Fragments.LaserScanFragment;
import com.vva.vvamobileclient.Fragments.MapFragment;
import com.vva.vvamobileclient.Fragments.OverviewFragment;
import com.vva.vvamobileclient.Fragments.PreferencesFragment;
import com.vva.vvamobileclient.Fragments.RosFragment;
...
//    private static LaserScanMap laserScanMap;
    ...
    // Bundle keys
    private static final String WAYPOINT_BUNDLE_ID = "com.vva.vvamobileclient.ControlApp.waypoints";
    private static final String SELECTED_VIEW_NUMBER_BUNDLE_ID = "com.vva.vvamobileclient.ControlApp.drawerIndex";
    private static final String CONTROL_MODE_BUNDLE_ID = "com.vva.vvamobileclient.Views.Fragments.JoystickFragment.controlMode";

    // The saved instance state
    private Bundle savedInstanceState;

    private VVAVoiceAudioRecord _vva_audio_recorder;
...
//        editor.putBoolean(getString(R.string.prefs_warning_beep_key), true);
        ...
        if (_vva_audio_recorder == null) {
            _vva_audio_recorder = new VVAVoiceAudioRecord();
        }
...
//    }
    ...
    /**
     * Record voice command from the mic and invoke voice
     * command (Speech Recognition) ROS service
     */
    public void ca_requestSpeechRecognition() {
        // Record the wav file from the mic and send it to the server
        Thread thread = new Thread(new Runnable() {
            @Override
            public void run() {
                try {
                    //Log.d(TAG, "new Thread started for AudioRecord and ROS service.");
                    //Log.d(TAG, "Starting audio recording...");
                    _vva_audio_recorder.startRecording();
                    Log.i(TAG, "Recording...");
                    Thread.sleep(5000);
                    Log.i(TAG, "Recording finished.");
                    String wav_filename = _vva_audio_recorder.stopRecording();

                    Log.i(TAG, "File saved in: " + wav_filename);

                    //Log.d(TAG,"Sending wav file to the server...");
                    controller.rc_requestSpeechRecognition(wav_filename);
                    //Log.d(TAG, "AudioRecord and ROS service Thread finished.");
                } catch (Exception e) {
                    Log.e(TAG, "", e);
                }
            }
        }, "AudioRecord and ROS Service client Thread");
